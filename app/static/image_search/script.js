...
async function fetchPopularImages() {
    try {
        ...
        // FIX: Utiliser le bon préfixe /image-search
        const response = await fetch(`${CONFIG.BACKEND_URL}/image-search/api/search/images?query=popular&per_page=${CONFIG.DEFAULT_IMAGES_PER_PAGE}`);
